...
public class WoodsterTabs {
	public static final DeferredRegister<CreativeModeTab> REGISTRY = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, WoodsterMod.MODID);
	public static final RegistryObject<CreativeModeTab> WOODSTER = REGISTRY.register("woodster",
